...
- Inside your solution, create new ASP.NET Core web application. Don't use any template - select empty template. Name this project `IdentityUtils.Demos.IdentityServer4.MultiTenant`
